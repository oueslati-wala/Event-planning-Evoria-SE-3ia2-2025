...
def liste_animations(request):
    ...
    return render(request, 'AnimationApp/animateur_list.html', {'animations': items})
...
class AnimateurCreate(LoginRequiredMixin, UserPassesTestMixin, CreateView):
    model = Animateur
...
class AnimateurUpdate(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    model = Animateur
    form_class = AnimateurForm
    template_name = "AnimationApp/animateur_form.html"
    success_url = reverse_lazy("animationapp:anim_list")
...
class AnimateurDelete(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    model = Animateur
